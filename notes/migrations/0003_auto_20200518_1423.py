# Generated by Django 3.0.6 on 2020-05-18 13:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            '''
            CREATE TRIGGER document_vector_update BEFORE INSERT OR UPDATE
            ON notes_note FOR EACH ROW EXECUTE PROCEDURE
            tsvector_update_trigger('document_vector', 'title', 'content');
            ''',
        ),
    ]
