...
from .mixins import NoteFormMixin, NoteOwnerMixin, NoteOwnerOrPublicMixin
...
class ViewNoteView(NoteOwnerOrPublicMixin, DetailView):
    """
...
class EditNoteView(NoteOwnerMixin, NoteFormMixin, UpdateView):
    """
...
class DeleteNoteView(NoteOwnerMixin, DeleteView):
    """
