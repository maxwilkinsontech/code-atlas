$(document).ready(function () {
    ...
    $('#orderingSelect').on('change', function () {
        var value = this.value;
        var url = '/staging/notes/mode/edit/?ordering='
